...
(define (install-zero-package)
  ;; rational package internal procedures
  (define numer (get 'numer '(rational)))
  ;; complex package internal procedures
  (define real-part (get 'real-part '(complex)))
  (define imag-part (get 'imag-part '(complex)))
  ;; polynomial package internal procedures
...
(define py (make-poly 'x '((1 1) (0 2))))
(define p1 (make-poly 'x '((2 (polynomial y (1 1) (0 2))) (1 (polynomial y (1 1) (0 2))))))
(define p2 (make-poly 'x '((1 (polynomial y (1 1) (0 2))) (0 (polynomial y (1 1) (0 2))))))
