...
(define x-com (make-complex-from-real-imag x-rat 5))
...
(add (make-complex-from-real-imag (make-rational 5 2) (make-rational 3 1))
     (make-complex-from-mag-ang (make-rational 3 2) (make-rational 3 2)))
